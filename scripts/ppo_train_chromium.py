...
def generate_training_data(media_files, sample_size=None):
    ...
    print(f"\n🎯 Processing {len(sampled_files)} image files...")
    print(f"   (Video and audio conversion will be supported in future versions)")
...
def main():
    """Main function"""
    print("=" * 60)
    print("🤖 PPO Training - Chromium Test Data")
    print("=" * 60)
    ...
    # Ask for small-scale test
    print("\n" + "=" * 60)
    print("🧪 Step 1: Small-scale test (5 files)")
    print("=" * 60)
