...
# 复制到 format-vue 插件
echo "📦 部署到 format-vue..."
mkdir -p "$PROJECT_ROOT/plugin/format-vue/bin"
cp "$PROJECT_ROOT/target/release/pixly-converter" "$PROJECT_ROOT/plugin/format-vue/bin/"
chmod +x "$PROJECT_ROOT/plugin/format-vue/bin/pixly-converter"
...
ls -lh "$PROJECT_ROOT/plugin/format-vue/bin/pixly-converter"
