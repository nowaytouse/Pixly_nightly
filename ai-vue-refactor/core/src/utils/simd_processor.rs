...
/// estimated SIMD倍数
 ...
 8.0 // AVX2canbyonceprocess832elementelement
 } else if self.supports_neon {
 4.0 // NEONcanbyonceprocess432elementelement
 } else {
 1.0 // SIMDsupport
 }
 }
...
// calculationpixelaveragevalue（blur）
