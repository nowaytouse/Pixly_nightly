...
//! - **Basic**: fileexists and size
//! - **Format**: formatdetection
//! - **Integrity**: filefull
//! - **Deep**: fulldecodingvalidation
//! - **Dimensions**: dimensiona致
//! - **Quality**: qualityevaluate
//!
//! ### conversionvalidation ( conversion_validator.rs)
...
/// Level 1: basiccheck (exists、size)
 Basic = 1,
/// Level 2: formatcheck
 Format = 2,
...
/// Level 4: depthcheck (fulldecoding)
 Deep = 4,
/// Level 5: dimensionvalidation (inputoutputa致)
 Dimensions = 5,
/// Level 6: qualityvalidation (elementdata、SSIM)
 Quality = 6,
}
...
/// isnopassvalidation
 pub passed: bool,
/// isnovalid（compatibilityold API）
...
/// inputfileinformation（conversion）
#[derive(Debug, Clone)]
...
// ========================================
// filevalidation API ( validation.rs)
// ========================================

/// ✅ Level 1: basicvalidation - fileexists and size
...
/// ✅ Level 5: dimensiona致validation - inputoutputcomparison
...
// ========================================
// conversionvalidation API ( conversion_validator.rs)
// ========================================
...
///
/// **performanceoptimization**: pairatlargefile（>10），use Rayon parallelprocessingcanperformance
///
/// # example
/// ```no_run
...
// use Arc<Mutex> error and warning（threadsecurity）
...
/// 🔍 fullconversionvalidation（composite has level）
...
// warningcountshouldsame（sequentialmaydifferent）
