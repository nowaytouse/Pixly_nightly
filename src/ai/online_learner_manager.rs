...
//! 🎓 at线学习Manager - globalsingleton
//! 
//! feature：
//! - globalsingletonOnlineLearner
//! - 跨conversionsession持久经验缓冲
//! - auto触发modelupdate
...
static GLOBAL_LEARNER: Lazy<Arc<Mutex<OnlineLearner>>> = Lazy::new(|| {
 // 🔥 defaultdisabled，need显式enabled
 let mut learner = OnlineLearner::new(
 PathBuf::from("models/ppo/actor_online.pth"),
 10 // every10次convert更newonce模型（降低threshold以便测试）
 );
 learner.disable(); // 🔥 default禁用
...
/// at线学习Manager
pub structure OnlineLearnerManager;
