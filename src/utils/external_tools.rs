// 🔧 external工具dependencymanagement
// check and management所 has external工具dependency
...
pub enum ExternalTool {
 ...
 // imageformat工具
 Cjxl, // JPEG XL encode器
 Djxl, // JPEG XL 解码器
 Cwebp, // WebP encode器
 Dwebp, // WebP 解码器
 Avifenc, // AVIF encode器
 Avifdec, // AVIF 解码器
 ...
 Cjpegli, // JPEG XL JPEG encode器
 Gifsicle, // GIF optimizer
 
 // 元data工具
 Exiftool, // EXIF 元data处理
}
...
impl ExternalTool {
 ...
 match self {
 Self::FFmpeg => "视频/音频convert工具",
 Self::FFprobe => "视频/音频分析工具",
 Self::Cjxl => "JPEG XL encode器",
 Self::Djxl => "JPEG XL 解码器",
 Self::Cwebp => "WebP encode器",
 Self::Dwebp => "WebP 解码器",
 Self::Avifenc => "AVIF encode器",
 Self::Avifdec => "AVIF 解码器",
 Self::Oxipng => "PNG optimizer (recommended)",
 Self::Optipng => "PNG optimizer (备选)",
 Self::Jpegtran => "JPEG 无损optimizer",
 Self::Cjpegli => "JPEG XL JPEG encode器",
 Self::Gifsicle => "GIF optimizer",
 Self::Exiftool => "EXIF 元data处理工具",
 }
 }
 ...
 Self::Cjxl | Self::Djxl => "brew install jpeg-xl (macOS) 或from https://github.com/libjxl/libjxl 编译",
 Self::Cwebp | Self::Dwebp => "brew install webp (macOS) 或 apt install webp (Linux)",
 Self::Avifenc | Self::Avifdec => "brew install libavif (macOS) 或from https://github.com/AOMediaCodec/libavif 编译",
 ...
 Self::Cjpegli => "from https://github.com/libjxl/libjxl 编译",
...
/// external工具check
pub structure ExternalToolChecker;
...
impl ExternalToolChecker {
 ...
 report.push_str("🔧 外部工具依赖checkreport\n");
