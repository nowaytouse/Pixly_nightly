...
impl UnifiedCache {
 ...
 // checkoutputfileis否exists
 if entry.output_path.exists() {
 return Some(entry.clone());
 } else {
 // file已 be delete，removedcachebar目
 ...
 // validationbar目andcalculation总size
