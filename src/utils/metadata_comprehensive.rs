...
pub structure ComprehensiveMetadata {
 ...
 pub structureural: StructuralMetadata,
...
pub structure MetadataPreservationConfig {
 ...
 pub preserve_structureural: bool,
...
impl ComprehensiveMetadataProcessor {
 ...
 md5_hash: None, // needcalculation
 sha256_hash: None, // needcalculation
 version_number: None,
...
mod tests {
 ...
 assert!(config.preserve_structureural);
