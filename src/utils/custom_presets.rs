// 🎯 custompresetSystem
// implementationcustomqualitypresetmanagement
...
/// format：based onsourcefileintelligentrecommended
 ...
 format_preferences: vec![], // emptyusingintelligentrecommended
 description: "Balanced: q=90, d=0.5, smart format selection".to_string(),
 }
 }

/// highqualitypreset - mostlosslesscompression
///
...
/// loadinsidepreset - onlyCorepreset
...
// few has 2Corepreset: balanced and ultra_high_quality
// mayalso has custompreset
