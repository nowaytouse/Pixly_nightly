...
// feature
 pub color_complexity: f64, // complexity (0-1)
 pub brightness: f64, // averagebrightness (0-255)
 pub contrast: f64, // contrast (0-1)
 pub saturation: f64, //  and degree (0-1)

// texturefeature
 pub edge_density: f64, // edgedensity (0-1)
 pub texture_complexity: f64, // texturecomplexity (0-1)
 pub noise_level: f64, // noise (0-1)

// insidefeature
 pub is_photo: bool, // whetherforphoto
 pub is_graphic: bool, // whetherforgraphic/designdraft
 pub is_screenshot: bool, // whetherforscreenshot
 pub has_transparency: bool, // whetherhastransparency

// qualityestimated
 pub estimated_quality: u8, // estimatedoriginalquality (0-100)
...
pub struct QualityRecommendation {
 ...
 pub effort: u8, // recommendedeffort (1-9)
 pub lossless: bool, // whetherrecommended
 pub confidence: f64, // recommendedconfidence (0-1)
 pub reasoning: String, // recommendedreason
}
...
// samplingpixel（forperformance， not analysis has pixel）
...
// photofeature：highcomplexity、 etc texturecomplexity、relativelylownoise
...
// graphic/designdraftfeature：lownoise、highcontrast
 if features.noise_level < 0.2 && features.contrast > 0.5 {
 features.is_graphic = true;
 }

// screenshotfeature：specificresolution、lownoise
...
// recommendedqualityslightlybelowestimatedquality
...
// then1: highqualitysource → lossless
...
// then2: designdraft/graphic + highquality → lossless
...
// then3: transparencyimage + highquality → lossless
...
// then4: lowpoint + highcomplexity → mayisrender
...
// then6: screenshot → highqualitylossy
