    ...
    class RustCLIExecutor {
        ...
        init() {
            ...
            try {
                ...
                log.info('PIXLY Rust CLI', LOG.RUST_CLI_USING_PATH, { path: this.path });
                ...
                log.info('PIXLY Rust CLI', LOG.RUST_CLI_AVAILABLE, { version: this.version });
            } catch (error) {
                this.available = false;
                this.error = error.message;
                log.error('PIXLY Rust CLI', LOG.RUST_CLI_INIT_FAILED, { error: error.message });
            }
        }
