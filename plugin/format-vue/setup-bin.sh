#!/bin/bash
# format-vue: 设置开发环境 - 创建符号链接到共享二进制

set -e
cd "$(dirname "$0")"

echo "🔗 Setting up format-vue development environment..."
...
if [ -f "../shared/bin/pixly-eagle-core" ]; then
    ...
    echo "✅ Symlinked: format-vue/bin/pixly-eagle-core -> ../shared/bin/pixly-eagle-core"
else
