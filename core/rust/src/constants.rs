...
mod tests {
    ...
    fn test_quality_validation() {
        assert!(validators::validate_quality(85).is_ok());
        assert!(validators::validate_quality(1).is_ok());
        assert!(validators::validate_quality(100).is_ok());
        assert!(validators::validate_quality(0).is_err());
        assert!(validators::validate_quality(150).is_err());
    }

    #[test]
    fn test_speed_validation() {
        assert!(validators::validate_speed(6).is_ok());
        assert!(validators::validate_speed(0).is_ok());
        assert!(validators::validate_speed(10).is_ok());
        assert!(validators::validate_speed(11).is_err());
    }

    #[test]
    fn test_image_dimensions() {
        assert!(validators::validate_image_dimensions(1920, 1080).is_ok());
        assert!(validators::validate_image_dimensions(0, 1080).is_err());
        assert!(validators::validate_image_dimensions(100000, 1080).is_err());
    }

    #[test]
    fn test_format_support() {
        assert!(validators::is_input_format_supported("jpg"));
        assert!(validators::is_input_format_supported("JPG"));
        assert!(!validators::is_input_format_supported("xyz"));
        
        assert!(validators::supports_lossless("png"));
        assert!(validators::supports_lossless("webp"));
        assert!(!validators::supports_lossless("jpg"));
    }

    #[test]
    fn test_tool_validation() {
        assert!(validators::is_valid_tool("cjxl"));
        assert!(validators::is_valid_tool("AVIFENC"));
        assert!(!validators::is_valid_tool("unknown"));
    }
}
